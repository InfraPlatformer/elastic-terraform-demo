# =============================================================================
# DEVELOPMENT ENVIRONMENT CONFIGURATION - AWS + AZURE WORKING
# =============================================================================
# Configuration with real Azure credentials for multi-cloud deployment
# =============================================================================
...
# Azure Configuration (REAL CREDENTIALS)
azure_subscription_id = "f0d02754-d8ca-4e7d-b010-ebac7cd463da"
azure_tenant_id = "g9383228gmail.onmicrosoft.com"
azure_client_id = "00000000-0000-0000-0000-000000000000"  # You'll need to create this
azure_client_secret = "your-client-secret"  # You'll need to create this
